...
<body>
  ...
  <!-- Contenedor general -->
  <!-- 🔹🔹🔹 AGREGADO: envolvemos todo el contenido principal dentro de .contenedor como en panel estudiante -->
  <div class="contenedor">  
    ...
    <!-- Contenido principal-->
    <main class="principal"> <!-- 🔹 Cambiado a main.principal como en el diseño del estudiante -->
